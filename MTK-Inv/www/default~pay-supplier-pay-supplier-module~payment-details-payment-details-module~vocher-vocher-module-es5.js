(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pay-supplier-pay-supplier-module~payment-details-payment-details-module~vocher-vocher-module"], {
    /***/
    ...
    /*! exports provided: VocherService */

    /***/
    function srcAppServiceVocherServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VocherService", function () {
      ...
      var VocherService = /*#__PURE__*/function () {
        function VocherService(db) {
          _classCallCheck(this, VocherService);

          this.db = db;
          this.vocherCollectionList = db.collection('Vocher');
        }

        _createClass(VocherService, [{
          key: "create",
          value: function create(Vocher) {
            return this.vocherCollectionList.add(Vocher)["catch"](this.handleError);
          }
        }, {
          key: "getVocherTypId",
          value: function getVocherTypId(id) {
            var voucherListObj = this.db.collection('Vocher', function (ref) {
              return ref.where('vocherTypeId', '==', id);
            }).snapshotChanges();
            this.vocherList = voucherListObj.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (changes) {
          ...
          key: "getVocherByVendorID",
          value: function getVocherByVendorID(id) {
            var voucherListObj = this.db.collection('Vocher', function (ref) {
              return ref.where('vendor', '==', id);
            }).snapshotChanges();
            this.vocherList = voucherListObj.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (changes) {
              return changes.map(function (a) {
                var data = a.payload.doc.data();
          ...
          key: "getVocherByCustomerID",
          value: function getVocherByCustomerID(id) {
            var voucherListObj = this.db.collection('Vocher', function (ref) {
          ...
          key: "getVocherVonderById",
          value: function getVocherVonderById(vendor) {
            var voucherListObj = this.db.collection('Vocher', function (ref) {
              return ref.where('vendor', '==', vendor);
            }).snapshotChanges();
            this.vocherList = voucherListObj.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (changes) {
              return changes.map(function (a) {
                var data = a.payload.doc.data();
          ...
          key: "getAllVoucherItems",
          value: function getAllVoucherItems() {
            var _this = this;

            this.joined$ = this.db.collection('vocherTransation').valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (voucherTransactions) {
              var ItemID = Object(lodash__WEBPACK_IMPORTED_MODULE_12__["uniq"])(voucherTransactions.map(function (bp) {
                return bp.ItemID;
              }));
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(voucherTransactions), Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(ItemID.map(function (ItemID) {
                return _this.db.collection('items', function (ref) {
                  return ref.where('id', '==', ItemID);
                }).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (items) {
                  return items[0];
                }));
              })));
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (_ref) {
              var _ref2 = _slicedToArray(_ref, 2),
                  voucherTransactions = _ref2[0],
                  items = _ref2[1];

              return voucherTransactions.map(function (voucherTransaction) {
                return Object.assign(Object.assign({}, voucherTransaction), {
                  author: items.find(function (a) {
                    return a.id === voucherTransaction.ItemID;
                  })
                });
              });
            }));
          ...
          value: function getAllVocher() {
            this.vocherList = this.vocherCollectionList.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (actions) {
          ...
          key: "updateVocher",
          value: function updateVocher(vocherObj, id) {
            return this.vocherCollectionList.doc(id).update(vocherObj)["catch"](this.handleError);
          }
        }, {
          key: "getVocher",
          value: function getVocher(id) {
            return this.vocherCollectionList.doc(id).valueChanges()["catch"](this.handleError);
          }
        }, {
          key: "addVocher",
          value: function addVocher(vendors) {
            return this.vocherCollectionList.add(vendors)["catch"](this.handleError);
          }
        }, {
          key: "removeVocher",
          value: function removeVocher(id) {
            return this.vocherCollectionList.doc(id)["delete"]()["catch"](this.handleError);
          }
        }, {
          key: "handleError",
      ...
      VocherService.ctorParameters = function () {
        return [{
          type: angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]
        }];
      };

      VocherService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], VocherService);
      /***/
    },
...
//# sourceMappingURL=default~pay-supplier-pay-supplier-module~payment-details-payment-details-module~vocher-vocher-module-es5.js.map