    ...
    function srcAppServiceLookupServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LookupService = /*#__PURE__*/function () {
        function LookupService(db) {
          ...
          this.db = db;
          this.lookupCollection = db.collection('lookup');
        }

        _createClass(LookupService, [{
          key: "create",
          value: function create(Category) {
            return this.lookupCollection.add(Category); //return this.db.list('/Category').push(Category);
          }
        }, {
          key: "getalllookup",
          value: function getalllookup() {
            this.lookups = this.lookupCollection.snapshotChanges().pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
          ...
          value: function getlookupBytype(id) {
            ...
            this.lookupList = lookupobject.pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_3__["map"])(function (changes) {
          ...
          value: function getlookup(id) {
            return this.lookupCollection.doc(id).valueChanges();
          }
        }, {
          key: "updatelookup",
          value: function updatelookup(lookup, id) {
            return this.lookupCollection.doc(id).update(lookup);
          }
        }, {
          key: "removelookup",
          value: function removelookup(id) {
            return this.lookupCollection.doc(id)["delete"]();
          }
        }]);
