...
let CatagoryService = class CatagoryService {
    ...
    getallCategorys() {
        this.Categorys = this.CategoryCollection.snapshotChanges().pipe(Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
...
//# sourceMappingURL=default~catagory-catagory-module~items-items-module~lookup-lookup-module-es2015.js.map