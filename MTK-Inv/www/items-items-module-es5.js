  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["items-items-module"], {
    ...
    function srcAppItemsItemsModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      ItemsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _items_routing_module__WEBPACK_IMPORTED_MODULE_5__["ItemsPageRoutingModule"], devextreme_angular__WEBPACK_IMPORTED_MODULE_7__["DxLookupModule"], devextreme_angular__WEBPACK_IMPORTED_MODULE_7__["DxTemplateModule"], ng2_search_filter__WEBPACK_IMPORTED_MODULE_8__["Ng2SearchPipeModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_9__["NgxPaginationModule"]],
    ...
    function srcAppItemsItemsPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _Service_catagory_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var _Service_lookup_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../Service/lookup.service */
      "./src/app/Service/lookup.service.ts");
      /* harmony import */


      var _Service_items_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../Service/items.service */
      "./src/app/Service/items.service.ts");
      /* harmony import */


      var _Service_item_category_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../Service/item-category.service */
      "./src/app/Service/item-category.service.ts");
      /* harmony import */


      var _Service_balance_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../Service/balance.service */
      "./src/app/Service/balance.service.ts");

      var ItemsPage = /*#__PURE__*/function () {
        function ItemsPage(fb, platform, CategoryService, ItemCategoryService, alertController, lookupService, itemsService, balanceService, lookupCatagoryService) {
        ...
        _createClass(ItemsPage, [{
          ...
          value: function SelectedValue(event) {
            ...
            this.filteredLookUp = this.listoflookup.filter(function (c) {
              return c.type == event.target.value;
            });
            this.itemsService.getItemByLookup(this.SelectedLookup).subscribe(function (res) {
              _this.filteredItemsByLookup = res;
            });
          }
        }, {
          key: "getDisplayExpr",
          ...
          value: function getLookUpCatagory() {
            var _this2 = this;

            this.lookupCatagoryService.getAllLookupCatagory().subscribe(function (result) {
              _this2.listOfLookUpCatagory = result;
              _this2.SelectedLookup = _this2.listOfLookUpCatagory[0].id;
            });
          }
        }, {
          key: "getItemBySelectedLookup",
          value: function getItemBySelectedLookup() {
            var _this3 = this;

            this.lookupCatagoryService.getAllLookupCatagory().subscribe(function (result) {
              _this3.listOfLookUpCatagory = result;
              _this3.SelectedLookup = _this3.listOfLookUpCatagory[0].id; // this.itemsService.getItemByLookup(this.SelectedLookup).subscribe(res=>{
          ...
          key: "getItemLookup",
          value: function getItemLookup() {
            var _this4 = this;

            this.lookupCatagoryService.getAllLookupCatagory().subscribe(function (res) {
              var selectedLookup = _this4.listOfLookUpCatagory[0].id;

              if (selectedLookup == _this4.SelectedLookup) {
                _this4.SelectedLookup = selectedLookup;

                _this4.itemsService.getItemByID(_this4.SelectedLookup).subscribe(function (res) {
                  _this4.listOfItemsSelected = res;
                  _this4.itemLookupList = res[0].id;
                });
              } else {
                _this4.SelectedLookup = _this4.SelectedLookup;
            ...
            try {
              this.lookupService.getAllLookUp().subscribe(function (result) {
                if (result.length > 0) {
                  ...
                  _this5.filteredLookUp = result;
                  _this5.selectedStore = _this5.filteredLookUp[0].id;
                } else {
                  _this5.AlertInternet();
                }
              });
            } catch (error) {
              console.log(error);
          ...
          key: "getStoreByName",
          value: function getStoreByName(id) {
            var _this6 = this;
          ...
          value: function getCategory() {
            ...
            this.CategoryService.getAllLookUpCategory().subscribe(function (result) {
              ...
              if (store) {
                _this7.getStoreByName(store.id);
              }
            }); // }
          }
        }, {
          key: "getAllItemCategory",
          value: function getAllItemCategory() {
            var _this8 = this;

            this.ItemCategoryService.getAllItemCategories().subscribe(function (result) {
              if (result.length > 0) {
                _this8.ListOfItemCategory = result;
                _this8.SelectedCatagory = _this8.ListOfItemCategory[1].id;
              } else {
                _this8.AlertInternet();
              }
            });
          } // }
          // catch(error) {
          ...
          value: function getItemList() {
            ...
            this.itemsService.getAllItem().subscribe(function (result) {
              _this9.listofItems = result;
            });
          }
        }, {
          key: "getItemListAfterSave",
          value: function getItemListAfterSave(quantity, storeid, name, amhricName, price) {
            var _this10 = this;

            this.itemsService.getAllItemKEY(quantity, storeid, name, amhricName, price).subscribe(function (result) {
              _this10.listofItems = result.sort(function (b, a) {
                return a.id - b.id;
              });
              _this10.ItemId = _this10.listofItems[0].id;

              _this10.balanceService.getBalanceByItemId(_this10.ItemId).subscribe(function (res) {
                _this10.res = res;
                _this10.a = res.length;
              });

              if (_this10.a > 0) {
                var balance = {
                  itemId: _this10.ItemId,
                  beginingAmount: _this10.res[0].price,
                  currentAmount: +_this10.res[0].currentAmount + price,
                  storeId: storeid
                };

                _this10.balanceService.updateBalance(balance, _this10.res[0].id);
              } else {
                var _balance = {
                  itemId: _this10.ItemId,
                ...
                _this10.balanceService.create(_balance);
          ...
          value: function onPickImage() {
            ...
            _capacitor_core__WEBPACK_IMPORTED_MODULE_6__["Plugins"].Camera.getPhoto({
              ...
              _this12.base64textString = 'data:image/png;base64,' + image.base64String;
            })["catch"](function (error) {
              console.log(error);

              if (_this12.usePicker) {
                _this12.filePickerRef.nativeElement.click();
              }
          ...
          value: function onFileChosen(event) {
            ...
            fr.onload = function () {
              ...
              _this13.base64textString = dataUrl;
            };
          ...
          value: function filter(query) {
            this.filteredItemsSearch = query.target.value ? this.listofItems.filter(function (p) {
          ...
          value: function Save() {
            ...
            if (this.regform.valid) {
              if (!this.itemId) {
                ...
                var amhricName = this.regform.get('AmaricName').value;
                var Quantity = this.regform.get('Quantity').value;
                var storeid = this.regform.get('storeid').value;
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this14.itemsService.removeItems(item.id);

                            _this14.regform.reset();
      ...
      ItemsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-items',
