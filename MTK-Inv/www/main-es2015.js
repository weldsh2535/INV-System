...
const routes = [
    ...
    {
        path: 'catagory',
        loadChildren: () => Promise.all(/*! import() | catagory-catagory-module */[__webpack_require__.e("default~catagory-catagory-module~items-items-module~lookup-lookup-module"), __webpack_require__.e("default~catagory-catagory-module~items-items-module"), __webpack_require__.e("catagory-catagory-module")]).then(__webpack_require__.bind(null, /*! ./catagory/catagory.module */ "./src/app/catagory/catagory.module.ts")).then(m => m.CatagoryPageModule)
    },
    {
        path: 'lookup',
        loadChildren: () => Promise.all(/*! import() | lookup-lookup-module */[__webpack_require__.e("default~catagory-catagory-module~items-items-module~lookup-lookup-module"), __webpack_require__.e("common"), __webpack_require__.e("lookup-lookup-module")]).then(__webpack_require__.bind(null, /*! ./lookup/lookup.module */ "./src/app/lookup/lookup.module.ts")).then(m => m.LookupPageModule)
    },
    {
        path: 'items',
        loadChildren: () => Promise.all(/*! import() | items-items-module */[__webpack_require__.e("default~catagory-catagory-module~items-items-module~lookup-lookup-module"), __webpack_require__.e("default~catagory-catagory-module~items-items-module"), __webpack_require__.e("common"), __webpack_require__.e("items-items-module")]).then(__webpack_require__.bind(null, /*! ./items/items.module */ "./src/app/items/items.module.ts")).then(m => m.ItemsPageModule)
    }
];
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        ...
        imports: [
            ...
            _ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonicModule"].forRoot(),
            angularfire2__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].firebase),
...
module.exports = __webpack_require__(/*! C:\Users\dell\Documents\invoentry\MTK-Inv\src\main.ts */"./src/main.ts");
