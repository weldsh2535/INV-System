...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VocherService", function() { return VocherService; });
...
let VocherService = class VocherService {
    constructor(db) {
        this.db = db;
    ...
    getVocherTypId(id) {
        ...
        this.vocherList = voucherListObj.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(changes => changes.map(a => {
    ...
    getVocherByVendorID(id) {
        const voucherListObj = this.db.collection('Vocher', ref => ref.where('vendor', '==', id)).snapshotChanges();
        this.vocherList = voucherListObj.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(changes => changes.map(a => {
            const data = a.payload.doc.data();
            const id = a.payload.doc.id;
            return Object.assign({ id }, data);
    ...
    getVocherByCustomerID(id) {
        const voucherListObj = this.db.collection('Vocher', ref => ref.where('userId', '==', id)).snapshotChanges();
        this.vocherList = voucherListObj.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(changes => changes.map(a => {
            const data = a.payload.doc.data();
            const id = a.payload.doc.id;
            return Object.assign({ id }, data);
    ...
    getAllVoucherItems() {
        this.joined$ = this.db.collection('vocherTransation').valueChanges()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(voucherTransactions => {
            const ItemID = Object(lodash__WEBPACK_IMPORTED_MODULE_12__["uniq"])(voucherTransactions.map(bp => bp.ItemID));
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(voucherTransactions), Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(ItemID.map(ItemID => this.db.collection('items', ref => ref.where('id', '==', ItemID)).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(items => items[0])))));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(([voucherTransactions, items]) => {
            return voucherTransactions.map(voucherTransaction => {
                return Object.assign(Object.assign({}, voucherTransaction), { author: items.find(a => a.id === voucherTransaction.ItemID) });
            });
        }));
    }
    getAllVocher() {
        this.vocherList = this.vocherCollectionList.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(actions => {
    ...
    updateVocher(vocherObj, id) {
        return this.vocherCollectionList.doc(id).update(vocherObj)
            .catch(this.handleError);
    }
    getVocher(id) {
        return this.vocherCollectionList.doc(id).valueChanges()
            .catch(this.handleError);
    }
    addVocher(vendors) {
...
VocherService.ctorParameters = () => [
    { type: angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
VocherService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=default~pay-supplier-pay-supplier-module~payment-details-payment-details-module~vocher-vocher-module-es2015.js.map